...
/* 1. Traga os funcionarios que trabalham no departamento de filmes ou roupas */
SELECT departamento, COUNT(*) AS n_obs FROM funcionarios
WHERE departamento in ("Jardim", "Lar", "Roupas", "filmes")
GROUP BY departamento; 

SELECT nome FROM funcionarios
WHERE departamento = "Roupas" OR departamento = "Filmes";

/* 2. Traga os funcionarios que trabalham no departamento de filmes ou lar para envio de email */
SELECT nome, email FROM funcionarios
WHERE departamento = "Lar" OR departamento = "Filmes";

/* 3. Traga os funcionarios que trabalham no departamento de jardim ou do sexo masculino */
SELECT nome FROM funcionarios
